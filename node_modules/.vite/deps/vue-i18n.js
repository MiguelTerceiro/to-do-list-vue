import { Ft as onMounted, Kn as ref, L as Text, M as Fragment, Mn as effectScope, Rn as isRef, U as computed, Yn as shallowRef, et as createVNode, gn as watch, nt as defineComponent, pt as h, ut as getCurrentInstance, xt as inject, zt as onUnmounted } from "./vue.runtime.esm-bundler-DaROHT9e.js";
//#region node_modules/@intlify/shared/dist/shared.js
/*!
...
//#endregion
//#region node_modules/@intlify/message-compiler/dist/message-compiler.js
/*!
...
//#endregion
//#region node_modules/@intlify/core-base/dist/core-base.js
/*!
...
function compile(message, context) {
	if (!__INTLIFY_DROP_MESSAGE_COMPILER__ && isString(message)) {
		checkHtmlMessage(message, isBoolean(context.warnHtmlMessage) ? context.warnHtmlMessage : true);
...
function createCoreContext(options = {}) {
	...
	if (isFunction(options.messageCompiler)) warnOnce(getWarnMessage$1(CoreWarnCodes.EXPERIMENTAL_CUSTOM_MESSAGE_COMPILER));
...
//#endregion
//#region node_modules/@intlify/vue-i18n-core/dist/vue-i18n-core.js
/*!
		...
		try {
			setupDevtoolsPlugin({
				...
				api.on.inspectComponent(({ componentInstance, instanceData }) => {
					if (componentInstance.vnode.el && componentInstance.vnode.el.__VUE_I18N__ && instanceData) inspectComposer(instanceData, componentInstance.vnode.el.__VUE_I18N__);
				});
				api.addInspector({
...
function getComposer$1(nodeId, i18n) {
	if (nodeId === "global") return i18n.global;
	else {
...
function createI18n(options = {}) {
	...
	const i18n = {
		async install(app, ...options) {
			...
			if (isPlainObject(options[0])) i18n.__composerExtend = options[0].__composerExtend;
			let globalReleaseHandler = null;
			if (__globalInjection) globalReleaseHandler = injectGlobalFields(app, i18n.global);
			if (__VUE_I18N_FULL_INSTALL__) apply(app, ...options);
...
function getComposer(i18n, target, useComponent = false) {
	...
	while (current != null) {
		composer = i18n.__getInstance(current);
...
//#endregion
//#region node_modules/vue-i18n/dist/vue-i18n.js
/*!
